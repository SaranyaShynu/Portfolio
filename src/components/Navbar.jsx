    ...
    <nav className="bg-white dark:bg-gray-900 shadow fixed top-0 w-full z-50 transition-all">
      <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-6 font-medium">
          <li><Link to="/" className="hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">Home</Link></li>
          ...
          <li><a href="#projects" className="hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">Projects</a></li>
           <li><Link to="/games" className="hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-400">Games</Link></li>
...
<div className="flex items-center gap-3">
        <button
          ...
          className="ml-4 bg-gray-200 dark:bg-gray-700 text-black dark:text-white px-3 py-2 rounded-lg"
        >
          {dark ? "☀ Light" : "🌙 Dark"}
        </button>
      </div>
